...
<body>
	...
	<form action="Login" class="login"  style="margin-left:600px;margin-top:100px; width: 400px;height: 300px;border: 1px solid black;">
		...
		<table style="margin-left:50px; width: 400px;height: 200px;">
			...
			<tr>
				<td></td>
				<td><input type="submit" id="button" class="button"
					value="login"></td>
		</table>
	</form>
</body>
