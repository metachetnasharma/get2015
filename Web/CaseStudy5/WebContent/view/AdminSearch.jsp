...
<link rel="styleSheet" href="/CaseStudy5/css files/SearchStyle.css">
<script src="/CaseStudy5/javaScript/Search.js"></script>
</head>
<body>
	<div class="wrapper">
		<header>
		...
		<aside>
			<ul>
				<li><a href="/CaseStudy5/view/AdminHome.jsp">HOME</a></li>
				<li><a href="/CaseStudy5/LogOutController">LOGOUT</a></li>
			</ul>
		</aside>
   <form action="/CaseStudy5/AdminSearchController" method="post">
	    <div class="heading">
	   <h2>Search</h2>
