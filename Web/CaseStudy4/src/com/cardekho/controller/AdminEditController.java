 ...
 * this servlet has control of AdminCarEditPage
 *************************************************/
...
public class AdminEditController extends HttpServlet {
	 ...
	 *      response)
	 *      will display AdminCarEdit page
	 */
		...
		if (session.getAttribute("admin") == null) {
			...
			try {
				...
				RequestDispatcher requestDispatcher = request
						.getRequestDispatcher("/view/AdminCarEdit.jsp");
	 ...
	 *      response)
	 *      this provides functionality for update
	 */
	protected void doPost(HttpServletRequest request,
		...
		if (session.getAttribute("admin") == null) {
			...
			try {
				...
				System.out.println("Exception while updating car "
						+ e.getMessage());
