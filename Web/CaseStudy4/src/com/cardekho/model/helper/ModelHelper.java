...
/***************************************************************************
 * this class is containing methods of creating vehicle list from result set
 **************************************************************************/
...
public class ModelHelper {
	...
	/**
	 * @param resultset
	 *            that contains vehicle information
	...
	/**
	 * @param resultset
	 *            that contains vehicle make or company name
	 * @return vehicleList List of Vehicles
	 */
	...
	public static Car createCar(HttpServletRequest request) {
		...
		car.setFuelCapacity(Integer.parseInt(request
